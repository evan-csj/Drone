...
float Kp[3] = {0, 20, 20};    // P coefficients in that order : Yaw, Pitch, Roll
float Ki[3] = {0, 0.001, 0.001}; // I coefficients in that order : Yaw, Pitch, Roll
float Kd[3] = {0, 250, 250};        // D coefficients in that order : Yaw, Pitch, Roll
